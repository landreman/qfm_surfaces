subroutine qfm_surfaces_deallocate
  ...
  deallocate(sin_m_theta, cos_m_theta, sin_n_phi, cos_n_phi, sin_phi, cos_phi, sin_theta, cos_theta, sin_n_phi_transpose, cos_n_phi_transpose)
  deallocate(Z,R)
  ...
  deallocate(residual_1D, residual_2D)
  ...
  deallocate(d_Bnormal_d_theta, d_Bnormal_d_phi, integrand, integrand_transpose, phi_copied)
