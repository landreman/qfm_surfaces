module qfm_surfaces_solver_variables
  ...
  real(dp), dimension(:), allocatable :: state_vector, state_vector0, last_state_vector, residual, residual0, residual_1D, step_direction
  ...
  logical :: found_match
  real(dp), dimension(:,:), allocatable :: sin_m_theta, cos_m_theta, sin_n_phi, cos_n_phi, sin_n_phi_transpose, cos_n_phi_transpose
  ...
  real(dp), dimension(:,:), allocatable :: d_Bnormal_d_theta, d_Bnormal_d_phi, integrand, integrand_transpose, residual_2D
