subroutine qfm_surfaces_differentiation_matrix(N, xMin, xMax, option, quadrature_option, x, weights, ddx, d2dx2)
...
end subroutine qfm_surfaces_differentiation_matrix
